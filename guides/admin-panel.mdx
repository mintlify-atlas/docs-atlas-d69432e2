---
title: "Manage Courts and Reservations as an Admin in ReservaFácil"
sidebarTitle: "Admin Panel"
description: "Admin guide for ReservaFácil: confirm or cancel bookings, create and edit courts, monitor pending reservations, and track platform revenue."
---

Users with the **ADMIN** role gain access to a dedicated management area at **[/admin](http://localhost:3000/admin)**. From here, admins can monitor all platform activity, confirm or cancel pending reservations, complete confirmed sessions, and maintain the catalogue of sports courts — without needing superadmin privileges.
