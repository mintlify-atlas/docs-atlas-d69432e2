...
<CardGroup cols={2}>
  ...
  <Card title="CANCELADA" icon="circle-xmark">
    **Red badge.** The reservation was cancelled — either by you before confirmation, or by an admin at any point. The slot is freed for others.
  </Card>
</CardGroup>
...
<Warning>
  Once a reservation moves to **CONFIRMADA** the self-cancel button is no longer shown. You must contact an admin directly to request a cancellation — they can update the status from the admin panel at `/admin/reservas`.
</Warning>
