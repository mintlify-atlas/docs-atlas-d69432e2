---
title: "List and Create Courts — ReservaFácil Courts API"
sidebarTitle: "List & Create"
description: "GET /api/canchas returns every court sorted alphabetically by name. POST /api/canchas creates a new court and requires ADMIN or SUPERADMIN role."
---
