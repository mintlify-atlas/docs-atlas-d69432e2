---
title: "Retrieve, Update, and Delete a Court by ID — ReservaFácil"
sidebarTitle: "Get, Update, Delete"
description: "GET /api/canchas/[id] retrieves a single court. PUT updates it (ADMIN or SUPERADMIN). DELETE permanently removes it (SUPERADMIN only)."
---
