---
title: "Log Out and Invalidate the Session | ReservaFácil Auth"
sidebarTitle: "Logout"
description: "Deletes the HTTP-only token cookie to immediately end the current session. No request body required; JWT auth is stateless with no server-side record."
---
