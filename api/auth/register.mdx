---
title: "Register a New User Account | ReservaFácil Auth API"
sidebarTitle: "Register"
description: "Creates a new USUARIO account, hashes the password with bcrypt at 10 rounds, and sets an HTTP-only JWT cookie valid for 7 days on success."
---
