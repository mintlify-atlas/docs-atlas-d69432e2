---
title: "ReservaFácil: Sports Court Booking Platform"
sidebarTitle: "Home"
description: "ReservaFácil is a full-stack sports court booking system with role-based dashboards for users, admins, and superadmins. Book courts, manage reservations, and track revenue."
---

ReservaFácil (CanchaYA) is a sports court booking platform built with Next.js, Prisma, and PostgreSQL. It lets end users browse available courts and make reservations, while admins confirm bookings and superadmins manage the full system — users, courts, and revenue reports.
